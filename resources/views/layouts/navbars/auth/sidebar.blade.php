<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            ...
            <span class="ms-1 font-weight-bold">renter Management <br> dashboard</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1"> Profile Renter</span>
                </a>
            </li>
            {{-- <li class="nav-item pb-2">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('locataires') }}">
                ...
                <span class="nav-link-text ms-1">Add renter</span>
            </a>
        </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tables' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Renter follow-up</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'paiement' ? 'active' : '' }}"
                    href="{{ route('paiement') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">summaries</span>
                </a>
            </li>
            <li class="nav-item">
