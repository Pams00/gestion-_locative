<main>
    <div class="container-fluid py-4">
     ...
     <div class="row mt-5 d-flex justify-content-center">
        <div class="col-md-6"> 
        <p>Amount of property : 
            <span>500000 Fcfa</span>
        </p>

        <form  action="" method="POST" enctype="multipart/form-data">
            @csrf
            <label for="nom" class="form-label">Renter Name</label>
            <input class="form-control" type="text" id="nom" name="name" aria-label="Disabled input example" >

            <label for="montant" class="form-label">Amound paid</label>
            <input class="form-control" type="number" id="montant" aria-label="Disabled input example" name="montant"  >

            <label for="date_paid" class="form-label">payment of date</label>
            <input class="form-control" id="date_paid" type="date">
           <br>
            {{-- <label for="next_date" class="form-label">Next payment</label>
            <input class="form-control" type="date"  aria-label="Disabled input example" disabled readonly> --}}
             <button type="submit" class="btn btn-success">payer</button>
        </form>
          
                 <p>La prochaine date de paiement est :</p>
                 <span><input class="form-control" type="date" disabled readonly> </span>
